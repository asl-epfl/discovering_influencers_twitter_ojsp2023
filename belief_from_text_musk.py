...
if __name__ == "__main__":
    ...
    df_tweets = pd.read_csv("musk_tweets_merged.csv",dtype=str)
    direct = "/elon_musk"
    user_node_file = open("./filtered_musk_19.txt","r")
    ...
    for UserID in user_nodes:
        ...
        scor_file = open(f"{direct}/elon_musk_beliefs.txt","a")
        activity_file = open(f"{direct}/elon_musk_activity.txt","a")
