...
if __name__ == "__main__":
    ...
    df_tweets = pd.read_csv("jour_tweets_merged.csv",dtype=str)
    direct = "/journalist"
    user_node_file = open("./filtered_jour_25.txt","r")
    ...
    for UserID in user_nodes:
        ...
        scor_file = open(f"{direct}/journalist_beliefs.txt","a")
        activity_file = open(f"{direct}/journalist_activity.txt","a")
        ...
        for tweet in user_tweets:
            ...
            try:
                ...
                sentiment_scores = roberta_sent_anal.eval_sentences_positive(tweets_clean)
